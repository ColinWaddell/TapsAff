...
$GLOABALS['json_url']='https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weather.forecast%20where%20woeid%20in%20(select%20woeid%20from%20geo.places(1)%20where%20text%3D%22LOCATION%2C%20uk%22)&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys';
...
$GLOBALS['weather_description'] = array(
  "Mental",     // 00 - tornado
  "Mental",     // 01 - tropical storm
  "Mental",     // 02 - hurricane
  "Radge",      // 03 - severe thunderstorms
  "Radge",      // 04 - thunderstorms
  "Boggin'",    // 05 - mixed rain and snow
  "Boggin'",    // 06 - mixed rain and sleet
  "Boggin'",    // 07 - mixed snow and sleet
  "Dreich",     // 08 - freezing drizzle
  "Pish",       // 09 - drizzle
